...
func (s *Service) GetUser(id domain.UUID) (*User, error) {
...
func (s *Service) GetUserProfile(userID domain.UUID) (*UserProfile, error) {
...
func (s *Service) GetUserDevices(userID domain.UUID) ([]*UserDevice, error) {
	return s.repo.GetDevicesByUserID(userID)
}

// Follow operations
func (s *Service) FollowUser(followerID, followingID domain.UUID) error {
...
func (s *Service) UnfollowUser(followerID, followingID domain.UUID) error {
	return s.repo.DeleteFollow(followerID, followingID)
}

func (s *Service) GetFollowers(userID domain.UUID) ([]*User, error) {
	return s.repo.GetFollowers(userID)
}

func (s *Service) GetFollowing(userID domain.UUID) ([]*User, error) {
...
func (s *Service) GetUserNotifications(userID domain.UUID) ([]*Notification, error) {
	return s.repo.GetNotificationsByUserID(userID)
}

func (s *Service) MarkNotificationAsRead(id domain.UUID) error {
